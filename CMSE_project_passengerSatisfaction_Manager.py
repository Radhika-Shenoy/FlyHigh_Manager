...
with st.sidebar:
    selected = option_menu( menu_title="FlyHigh Manager Navigation options",
    options=["Home",'Overall Airline Stats', "Analysis Page","Analysis Results","Manager Feedback"],
...
if selected == 'Home':
    ...
    with tab2:
        ...
        nx.draw(G, pos, with_labels=True, node_size=3000, node_color='skyblue', font_size=12, font_weight='bold',alpha=0.7)
